...
public:
	...
	static char unmount(char part);		// demontira particiju oznacenu datim slovom
										// vraca 0 u slucaju neuspeha ili 1 u slucaju uspeha

	static char format(char part);		// formatira particiju sa datim slovom;
										// vraca 0 u slucaju neuspeha ili 1 u slucaju uspeha

	static char doesExist(char* fname);		// argument je naziv fajla ili direktorijum sa apsolutnom putanjom
	...
	static char readDir(char* dirname, EntryNum n, Entry &e);		// prvim argumentom se zadaje apsolutna putanja,
																// drugim redni broj ulaza koji se cita, treci
																// argument je adresa na kojoj se smasta 
																// procitani ulaz
